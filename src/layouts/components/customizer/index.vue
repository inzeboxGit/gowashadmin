<template>
  <BOffcanvas v-model="isCustomizerOpen" placement="end" class="overflow-hidden" header-class="p-0" body-class="p-0">
    <template #header>
    ...
    <template #footer>
      <div class="offcanvas-footer border-top p-3 text-center">
        <BRow class="justify-content-end">
          <BCol cols="6">
            <a :href="META_DATA.buyUrl" target="_blank" rel="noopener noreferrer" class="btn btn-success fw-semibold py-2 w-100"> <Icon icon="shopping-basket" class="me-2 fs-md"></Icon> Buy Now </a>
          </BCol>
          <BCol cols="6">
            <BButton @click="reset" variant="danger" class="fw-semibold py-2 w-100"> <Icon icon="refresh-ccw" class="me-2 fs-md"></Icon>Reset </BButton>
          </BCol>
        </BRow>
      </div>
    </template>
