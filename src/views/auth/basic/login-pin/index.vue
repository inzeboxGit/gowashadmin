          ...
          <BCard class="p-4" no-body>
            ...
            <BForm>
              ...
              <div class="d-grid mt-3">
                <BButton type="submit" variant="primary" class="fw-semibold py-2 w-100"> Confirm </BButton>
              </div>
            </BForm>
...
import { BButton, BCard, BCol, BContainer, BForm, BRow } from 'bootstrap-vue-next'
import { ref } from 'vue'
