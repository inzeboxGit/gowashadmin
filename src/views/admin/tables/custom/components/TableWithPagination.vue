<template>
  <BCard no-body>
    <BCardHeader>
      <BCardTitle as="h4">Custom table with pagination</BCardTitle>
    </BCardHeader>
    ...
    >
      ...
      <template #cell(action)="{ item }">
        <div class="d-flex justify-content-center gap-1">
          <BButton variant="light" size="sm" class="btn-icon rounded-circle">
            <Icon icon="eye" class="fs-lg" />
          </BButton>
          <BButton variant="light" size="sm" class="btn-icon rounded-circle">
            <Icon icon="square-pen" class="fs-lg" />
          </BButton>
          <BButton variant="danger" size="sm" class="btn-icon rounded-circle" @click="handleDeleteItem(item)"> <Icon icon="trash-2" class="fs-lg" /> </BButton>
        </div>
      </template>
    </BTable>
