<template>
  <BCard no-body>
    <BCardHeader>
      <BCardTitle as="h4">Custom table with pagination Info </BCardTitle>
    </BCardHeader>
    ...
    >
      ...
      <template #cell(action)="{ item }">
        <div class="d-flex justify-content-center gap-1">
          ...
          <BButton variant="danger" class="btn btn-icon btn-sm rounded-circle" @click="handleDeleteItem(item)"> <Icon icon="trash-2" class="fs-lg" /> </BButton>
        </div>
      </template>
    </BTable>
