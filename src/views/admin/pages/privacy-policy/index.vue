<template>
  ...
  <BRow class="justify-content-center">
    <BCol cols="12">
      <BCard class="position-relative" no-body>
        <div class="position-absolute top-0 end-0">
          <img src="/images/auth-card-bg.svg" class="auth-card-bg-img" style="opacity: 0.7" alt="auth-card-bg" width="600" height="560" />
        </div>
        ...
        <BCardBody>
          ...
          <p>
            ...
            <RouterLink to="mailto:privacy@example.com">privacy@example.com</RouterLink>
            .
          </p>
