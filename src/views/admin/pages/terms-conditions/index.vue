    ...
    <BCol cols="12">
      <BCard no-body class="position-relative">
        <div class="position-absolute top-0 end-0">
          <img src="/images/auth-card-bg.svg" class="auth-card-bg-img" style="opacity: 0.7" alt="auth-card-bg" width="600" />
        </div>
        ...
        <BCardBody class="position-relative">
          ...
          <p class="mt-4">For any questions regarding these Terms, please contact us at <RouterLink to="mailto:support@example.com">support@example.com</RouterLink>.</p>
