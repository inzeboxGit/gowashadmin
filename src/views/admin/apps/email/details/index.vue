    ...
    <BCard no-body class="card h-100 mb-0 rounded-start-0 flex-grow-1 border-start-0">
      ...
      <BCardHeader class="card-bg justify-content-between">
        <div class="d-flex flex-wrap align-items-center gap-1">
          <RouterLink to="/apps/email/inbox" class="btn btn-default btn-icon btn-sm" title="Back to Inbox">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto d-flex align-items-center gap-1">
              ...
              <button class="btn btn-icon btn-sm btn-ghost-light text-dark rounded-circle">
                <Icon icon="forward" class="fs-lg" />
              </button>
              <button class="btn btn-icon btn-sm btn-ghost-light text-dark rounded-circle">
                <Icon icon="mail-open" class="fs-lg" />
              </button>
          ...
          <BCollapse v-model="isOpenCollapse2" class="mt-3">
            ...
            <div class="mt-2 d-flex flex-wrap gap-2">
              <div class="d-flex p-2 gap-2 align-items-center text-start position-relative border border-dashed rounded">
                ...
                <div>
                  <h4 class="fs-sm mb-1">
                    <RouterLink to="" class="link-reset stretched-link">testimonial-glitch.mp4 </RouterLink>
                  </h4>
          ...
          <BCollapse v-model="isOpenCollapse3" class="mt-3">
            ...
            <div class="mt-2 d-flex flex-wrap gap-2">
              <div class="d-flex p-2 gap-2 align-items-center text-start position-relative border border-dashed rounded">
                ...
                <div>
                  <h4 class="fs-sm mb-1">
                    <RouterLink to="" class="link-reset stretched-link">footer-contrast-notes.pdf </RouterLink>
                  </h4>
              ...
              <div class="d-flex p-2 gap-2 align-items-center text-start position-relative border border-dashed rounded">
                <Icon icon="image" class="fs-24 text-secondary" />
                <div>
                  <h4 class="fs-sm mb-1">
                    <RouterLink to="" class="link-reset stretched-link">responsive-issues.png </RouterLink>
                  </h4>
          ...
          <BCollapse v-model="isOpenReply" class="mt-2 pb-5">
            ...
            <div class="bg-light-subtle p-2 rounded-bottom border border-top-0">
              <div class="d-flex gap-1 align-items-center">
                ...
                <button type="button" class="btn btn-sm btn-success"><Icon icon="send-horizontal" class="me-1" /> Send</button>
              </div>
            </div>
          </BCollapse>
        </div>
