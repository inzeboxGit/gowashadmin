<template>
  <PageBreadcrumb title="Ajouter une Promo" subtitle="Ecommerce" />

  <BRow>
    <BCol xl="8" class="mx-auto">
      <BCard no-body>
        <BCardHeader class="border-light">
          <h4 class="card-title mb-0">Créer un nouveau code promo</h4>
        </BCardHeader>
        <BCardBody>
            ...
            <BRow class="mb-3">
              <BCol md="6">
                <div class="mb-3">
                  ...
                  <BFormInput id="promoCode" v-model="form.code" placeholder="ex: GW12345" required />
                </div>
              </BCol>
              <BCol md="6">
                <div class="mb-3">
...
import { createPromo } from '~/services/promos.service'
