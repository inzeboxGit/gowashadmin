<template>
  ...
  <BRow>
    <BCol xxl="6">
      <CardWithAction title="Default Tabs" isTogglable>
    ...
    <BCol xxl="6">
      <CardWithAction title="Tabs Justified" isTogglable>
    ...
    <BCol xxl="6">
      <CardWithAction title="Tabs Vertical Left" isTogglable>
        <BRow>
          <BTabs content-class="pt-0" nav-class="text-left" nav-wrapper-class="col-sm-3 mb-2 mb-sm-0" pills vertical justified>
    ...
    <BCol xxl="6">
      <CardWithAction title="Tabs with Colored Navs" isTogglable>
        <BRow>
          <BTabs active-nav-item-class="bg-secondary" content-class="pt-0" nav-class="text-left" nav-wrapper-class="col-sm-3 mb-2 mb-sm-0" pills vertical justified end>
            <BTab title="Overview" active>
              <p class="mb-2">Welcome to your dashboard. Get an at-a-glance view of your recent activity, top stats, and personalized suggestions to enhance productivity and stay on track.</p>
              <ul>
                <li>View total project status</li>
    ...
    <BCol xxl="6">
      <CardWithAction title="Tabs Bordered" isTogglable>
    ...
    <BCol xxl="6">
      <CardWithAction title="Bordered Tabs with Colored Border" isTogglable>
        <BTabs justified nav-class="nav-bordered nav-bordered-danger mb-3">
          <BTab>
            <template #title>
              <Icon icon="home" class="fs-lg me-md-1 align-middle" />
          ...
          <BTab active>
            <template #title>
              <Icon icon="circle-user-round" class="fs-lg me-md-1 align-middle" />
          ...
          <BTab>
            <template #title>
              <Icon icon="settings" class="fs-lg me-md-1 align-middle" />
          ...
          <BTab>
            <template #title>
              <Icon icon="info" class="fs-lg me-md-1 align-middle" />
              <span class="d-none d-md-inline-block align-middle">Profile</span>
            </template>
            <p class="mb-0">
              Our company is dedicated to offering high-quality services and products designed to enrich your life. With a focus on sustainability and innovation, we aim to create lasting value for our customers. Join us on our journey to make everyday living better!
    ...
    <BCol xxl="6">
      <CardWithAction title="Icons Tabs" isTogglable>
        <BTabs nav-class="nav-bordered nav-bordered-suceess mb-3">
          <BTab title="Overview">
            <template #title>
              <Icon icon="home" class="fs-22 align-middle" />
            </template>
            <p class="mb-0">This dashboard provides a quick overview of your recent activity, performance metrics, and system status. You can easily monitor key indicators, recent logins, pending tasks, and overall user engagement.</p>
          </BTab>
          <BTab active>
            <template #title>
              <Icon icon="user" class="fs-22 align-middle" />
            </template>
            <p class="mb-0">View your latest interactions and actions taken across the platform. This includes recent file uploads, comments, status updates, and notification history to keep you up to date with ongoing changes.</p>
          </BTab>
          <BTab>
            <template #title>
              <Icon icon="settings" class="fs-22 align-middle" />
            </template>
            <p class="mb-0">Customize your account preferences including theme options, notification settings, and privacy controls. Adjust layout configurations to suit your workflow and manage integration with third-party services.</p>
          </BTab>
          <BTab>
            <template #title>
              <Icon icon="info" class="fs-22 align-middle" />
            </template>
            <p class="mb-0">
              Our company is dedicated to offering high-quality services and products designed to enrich your life. With a focus on sustainability and innovation, we aim to create lasting value for our customers. Join us on our journey to make everyday living better!
            </p>
          ...
          <BTab>
            <template #title>
              <Icon icon="briefcase" class="fs-22 align-middle" />
            </template>
          ...
          <BTab>
            <template #title>
              <Icon icon="mail" class="fs-22 align-middle" />
            </template>
    ...
    <BCol xxl="6">
      <CardWithAction title="Card with Tabs" isTogglable>
        <BTabs title="Card with Tabs" card justified nav-class="card-header-tabs nav-bordered ms-auto">
          <BTab title="Summary" active>
            <p class="mb-0">Welcome to your financial dashboard. Here, you can monitor real-time updates on your income, expenses, savings, and investments. Our tools are designed to help you make informed decisions and achieve your financial goals faster.</p>
          </BTab>
          <BTab title="Account">
