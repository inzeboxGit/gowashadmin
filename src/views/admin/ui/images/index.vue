<template>
  ...
  <BRow>
    <BCol xl="12">
      <CardWithAction title="Shapes" isTogglable>
        ...
        <BRow>
          ...
          <BCol sm="2" class="text-center">
            <img src="/images/users/user-5.jpg" alt="image" class="img-fluid rounded-circle" width="120" />
            <p class="mb-0 mt-2">
    ...
    <BCol xxl="6">
      <CardWithAction title="Avatar Sizes" isTogglable>
    ...
    <BCol xxl="6">
      <CardWithAction title="Avatar Sizes with Rounded" isTogglable>
        <BRow class="text-center">
          <BCol>
    ...
    <BCol xxl="12">
      <CardWithAction title="Avatar Groups" isTogglable>
        <BRow>
          <BCol xl="3">
