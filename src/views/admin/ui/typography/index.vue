<template>
  ...
  <BRow>
    <BCol lg="4">
      <CardWithAction title="Display Headings" isTogglable>
    ...
    <BCol lg="4">
      <CardWithAction title="Headings" isTogglable>
      ...
      <CardWithAction title="Naming a Source" isTogglable>
    ...
    <BCol lg="4">
      <CardWithAction title="Inline Text Elements" isTogglable>
    ...
    <BCol xl="4">
      <CardWithAction title="Unordered" isTogglable>
    ...
    <BCol xl="4">
      <CardWithAction title="Ordered" isTogglable>
    ...
    <BCol xl="4">
      <CardWithAction title="Unstyled" isTogglable>
        <p class="text-muted">
    ...
    <BCol xl="4">
      <CardWithAction title="Abbreviations" isTogglable>
    ...
    <BCol xl="4">
      <CardWithAction title="Alignment" isTogglable>
    ...
    <BCol xl="4">
      <CardWithAction title="Inline" isTogglable>
    ...
    <BCol xl="6">
      <CardWithAction title="Blockquotes" isTogglable>
        <p class="text-muted">
    ...
    <BCol xl="6">
      <CardWithAction title="Description List Alignment" isTogglable>
        <p class="text-muted">
