<template>
  <BCard no-body>
    ...
    <BCardBody>
      <ApexChart :get-options="getTaskProgressChart" :series="getTaskProgressChart().series" type="bubble" :height="330" />
    </BCardBody>
  </BCard>
</template>
